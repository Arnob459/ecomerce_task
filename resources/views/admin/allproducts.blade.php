                ...
                <tbody class="table-border-bottom-0">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <br>
                        <a href="{{ route('admin.editproductimg', $product->id )}}" class="btn btn-primary">Update Image</a>

                    </td>
                    <td>{{ $product->price }}</td>
                    <td>
                        <a href="{{ route('admin.editproduct', $product->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('admin.deleteproduct', $product->id) }}" class="btn btn-warning">Delete</a>
